...
if qt_module == "PySide":
    ...
    from oyProjectManager.ui import \
        version_creator_UI_pyside as version_creator_UI
    ...
    from oyProjectManager.ui import \
        version_creator_UI_pyqt4 as version_creator_UI
...
class MainDialog(QtGui.QDialog, version_creator_UI.Ui_Dialog):
    ...
    def _set_defaults(self):
        ...
        # fill the users
        users = User.query().filter(User.active == True).order_by(
            User.name).all()
