...
class MainDialog(QtGui.QDialog, assetManager2_UI.Ui_Dialog):
    ...
    def _setDefaults(self):
        ...
        if lastUser != '' and lastUser != None:
            userIndex = self.assetCreatorUI.user_comboBox1.findText(lastUser) 
    ...
    def updateProjectList(self):
        ...
        self.assetCreatorUI.server_comboBox.addItem( serverPath )
    ...
    def updateForNoSubName(self):
        ...
        self.assetCreatorUI.subName_listWidget.setEnabled(not currentSequence.noSubNameField)
        self.assetCreatorUI.subName_lineEdit.setEnabled(not currentSequence.noSubNameField)
